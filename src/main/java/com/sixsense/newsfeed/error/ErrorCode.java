...
public enum ErrorCode {
    ...
    USER_ALREADY_EXISTS(HttpStatus.CONFLICT, "USER_ALREADY_EXISTS", "이미 가입된 이력이 있는 계정입니다."),
    ...
    FOLLOWING_ALREADY_EXISTS(HttpStatus.CONFLICT, "FOLLOWING_ALREADY_EXISTS", "이미 팔로잉 상태입니다."),
    ;
